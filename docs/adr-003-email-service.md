...
1. **Group email / broadcast** — the primary admin or a council member composing and sending an email to a group (Council, First Gen, Second Gen, Third Gen, Work Party, or All Members). This is one of the three core MVP pillars and the primary use case for the email service.
...
- **Group broadcast** — the main email template for the primary admin's group emails, with the portal's branding, the composed message body, and an unsubscribe/preferences link
