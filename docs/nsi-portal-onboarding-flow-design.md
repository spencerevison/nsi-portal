...
| **No ticket parameter** | Direct navigation to /sign-up without an invitation | Missing `__clerk_ticket` | "This portal is invite-only. If you're a community member, please check your email for an invitation or contact your administrator." | No self-registration path; display contact info for the primary admin |
...
| **Expired ticket** | Error state: "This invitation link has expired." Body: "Please contact your community administrator for a new invitation." Contact info for the primary admin. No form displayed. |
...
- This should be flagged to the primary admin as a known constraint during initial member data collection
